        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item selected">
              <a class="sidebar-link active" href="./archives.php" aria-expanded="false">
                <span>
            ...
            <div class="card">
              <div class="" id="headingOne">
                <button class="btn btn-link card-header w-100 text-decoration-none" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                  <h5 class="mb-0 card-title fw-semibold text-start">Classement soirées A23
                  </h5>
                </button>
              </div>
                  ...
                  <div class="card-body" style="padding: 0px!important;">
                    <div class="table-responsive">
                      <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                          <?php
                          $json_data = file_get_contents('./soirees/A23/A23_GLOBAL.json');
